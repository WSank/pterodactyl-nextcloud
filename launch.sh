...
if [[ ! -f "./logs/installed" ]]; then
  curl -sSL https://raw.githubusercontent.com/WSank/pterodactyl-nextcloud/refs/heads/main/installer.sh -o installer.sh;
...
EOL
  ...
  curl -sSL https://raw.githubusercontent.com/WSank/pterodactyl-nextcloud/refs/heads/main/supervisord.conf -o supervisord.conf
  curl -sSL https://raw.githubusercontent.com/WSank/pterodactyl-nextcloud/refs/heads/main/supervisor.sh -o supervisor.sh
